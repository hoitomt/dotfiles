...
SDK_PATH = "#{ENV['HOME']}/Code/android_sdk/adt-bundle-mac-x86_64-20131030/sdk"
...
Dir.chdir(SDK_PATH) do
  ...
  unless system("./#{adb} remount")
    system "./#{emulator} -avd Android_412 -partition-size 512 &"
  end
  ...
  system "#{adb} push ~/tmp/hosts /system/etc"
